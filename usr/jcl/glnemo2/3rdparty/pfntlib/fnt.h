/*
     ...
     $Id: fnt.h,v 1.1 2010/10/25 09:15:02 jcl Exp $
*/
...
public:
  ...
  void end ()
  {
    glDisable( GL_TEXTURE_2D ); // Add by JCL
    bound = FNT_FALSE ;
  }
...
class fntBitmapFont : public fntFont
{
 ...
 public:
    ...
    virtual int load ( const char *fname, GLenum mag, GLenum min ) { 
      if (fname||mag||min) {;} // remove compiler warning
      return -1; 
    }
