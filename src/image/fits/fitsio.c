...
static char *cvs_id="$Id: fitsio.c,v 1.15 2011/10/06 16:44:03 pteuben Exp $ fitsio.c";
...
local string cfits3="nemo::fitsio.c $Id: fitsio.c,v 1.15 2011/10/06 16:44:03 pteuben Exp $";
